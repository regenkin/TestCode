        ...
        public WfResult Create(WfParameter parameter)
        {
            ...
            try
            {
                ...
                if (!parameter.isNew)
                {
                    // 如果是重新发起的流程需要获取当前任务
                    // 更新当前任务节点
                    wfTaskIBLL.UpdateStateByNodeId(parameter.processId, startNode.id, parameter.userId, parameter.userName);
            ...
            try
            {
                ...
                else if (currentTask.F_IsFinished == 1)
                {
                    ...
                    else
                    {
                        ...
                        // 更新当前任务节点
                        wfTaskIBLL.UpdateStateByNodeId(currentTask.F_ProcessId, currentTask.F_NodeId, parameter.userId, parameter.userName);
