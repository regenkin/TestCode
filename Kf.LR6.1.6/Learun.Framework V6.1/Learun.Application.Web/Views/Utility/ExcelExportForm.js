...
var bootstrap = function ($, learun) {
    ...
    var page = {
        init: function () {
            var columnModel = learun.frameTab.currentIframe().$('#gridtable').jfGridGet('settingInfo').headData;
    ...
    acceptClick = function (callBack) {
        ...
        var columnJson = JSON.stringify(learun.frameTab.currentIframe().$('#gridtable').jfGridGet('settingInfo').headData);
        var rowJson = JSON.stringify(learun.frameTab.currentIframe().$('#gridtable').jfGridGet('showData'));
        learun.download({
            method: "POST",
