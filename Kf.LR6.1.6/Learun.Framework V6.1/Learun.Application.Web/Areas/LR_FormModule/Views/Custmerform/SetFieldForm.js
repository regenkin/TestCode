...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#type').lrselect({
                placeholder: false,
                data: [{ id: 'input', text: 'input' }, { id: 'label', text: 'label' }, { id: 'select', text: 'select' }, { id: 'fixedInfo', text: '固定信息' }],
                select: function (item) {
                    $('.data-edit-select').hide();
                    $('.data-edit-fixedInfo').hide();
                    
                    if (item.id == "select") {
                        $('.data-edit-select').show();
                    }
                    else if (item.id == "fixedInfo") {
                        $('.data-edit-fixedInfo').show();
                    }
                }
            }).lrselectSet('input');
            // 对齐方式
